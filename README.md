...
## Clojure
* [Rich Hickey - The Value of Values (condensed)](https://youtu.be/-6BsiVyC1kM)
...
* [Alex Crichton - Rust for Systems Programming](https://youtu.be/GbWECt0M3CI)
* [Aaron Turon - The Rust Programming Language](https://youtu.be/O5vzLKg7y-k)
* [Jack Moffitt - Servo: Building a Parallel Browser](https://youtu.be/7q9vIMXSTzc)
...
* [Rob Pike - Another Go at Language Design](https://youtu.be/7VcArS4Wpqk)

# Version Control (Software Configuration Management)
* [Linus Torvalds - Git](https://youtu.be/4XpnKHJAok8)
* [Scott Chacon - Introduction to Git](https://youtu.be/ZDR433b0HJY)
* [Matthew McCullough - Git: Graphs, Hashes, Compression](https://youtu.be/ig5E8CcdM9g)
* [Tim Berglund - Git from the Bits Up](https://youtu.be/MYP56QJpDr4)
* [Mary Rose Cook - Git from the Inside Out](https://youtu.be/fCtZWGhQBvo)
* [Richard Hipp - Fossillize your Code](https://youtu.be/-ceEWWqaVsI)
* [Richard Hipp - Git: Just Say No](https://youtu.be/ghtpJnrdgbo)

# SQLite
* [Richard Hipp - SQLite: Google Presentation](https://youtu.be/giAMt8Tj-84)
* [Richard Hipp - SQLite](https://youtu.be/Jib2AmRb_rk)
* [Richard Hipp - SQLite: CMU Presentation](https://youtu.be/gpxnbly9bz4)
